        ...
        <div class="list-group">
            ...
            <div class="my-3 alert" style="background: #f0f0f0">
                ...
                <ul class="nav nav-tabs mt-3">
                    <li class="nav-item">
                        <a class="nav-link active" data-toggle="tab" href="#response_{{$key}}">Response</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link " data-toggle="tab" href="#payload_{{$key}}">Payload</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade " id="payload_{{$key}}">
                    ...
                    <div class="tab-pane fade show active" id="response_{{$key}}">
                            <?php
